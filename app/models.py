"""
Microblog SQL models with implemented via SQLAlchemy
...
# Define a followers association table
followers = sa.Table(
    'followers',
    db.metadata,
...
class User(UserMixin, db.Model):
    ...
    # Adding two many-to-may followers relationship attributes
    ...
    # Adding private message support
...
# Paginated representation mixin class
